...
def add_fuel_cell(f, N, *, prefix: str = "FC_"):
    ...
    it specified.
    """
    fc = f.group("fuel_cell", prefix=prefix)
    V = fc.Variable
    Vn = lambda n, g, u, d: fc.Variable(n, g, u, d, size=N)
    Vb = lambda n, g, u, d, bd: fc.Variable(n, g, u, d, size=N, bounds=bd)
    C = lambda n, v, u, d: fc.Constant(n, v, u,
                                      d)
